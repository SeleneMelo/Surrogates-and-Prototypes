...
Objetivo: Treinar um surrogate com uma árvore de decisão (CART) como modelo interpretável, usando os mesmos dados de treino originais para aproximar o comportamento do modelo caixa-preta.
